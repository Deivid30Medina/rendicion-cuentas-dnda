          ...
          <div className='w-full bg-white border-custom-2 border-custom-black flex flex-wrap flex-col xl:flex-row items-start justify-center px-8 rounded-xl -mt-28 mb-12 py-5'>
            <div className='w-full xl:flex xl:flex-wrap xl:items-start'>
              ...
              <div className='flex flex-wrap justify-start items-start xl:items-center flex-row w-full h-auto gap-2 mt-12'>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.facebook.com/derechodeautor"><IconoWebDnda width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.derechodeautor.gov.co/es"><IconFacebook width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://x.com/i/flow/login?redirect_after_login=%2FDerechodeautor"><IconX width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.instagram.com/derechodeautor/"><IconInstagram width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.youtube.com/@DERECHODEAUTORCOL"><IconYoutube width={20} height={20} className='cursor-pointer'/>derechodeautorcol</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.tiktok.com/@derechodeautorcol?lang=es"><IconoTickTock width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.linkedin.com/in/direcci%C3%B3n-nacional-de-derecho-de-autor-de-colombia-7210b915b/"><IconoLinkedin width={20} height={20} className='cursor-pointer'/>/company/derechodeautor</a>
                <a className='text-xl text-color-dnda-oscuro flex items-center justify-start flex-nowrap gap-2 min-w-52 min-h-9' href="https://www.threads.net/@derechodeautor"><IconoThread width={20} height={20} className='cursor-pointer'/>@derechodeautor</a>
              </div>
