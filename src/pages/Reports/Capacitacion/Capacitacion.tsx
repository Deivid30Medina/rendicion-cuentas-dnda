  ...
  return (
    <>
      <div className="w-full flex items-start justify-between flex-nowrap pt-12 gap-4">
        <IconCapacitacion
          className="h-24 min-w-28 max-w-32 border-2 border-color-dnda rounded-lg"
          colorSvg="#004884"
        />
        <div className="flex flex-col items-start justify-center">
          ...
          <p>
            Su objetivo es contribuir en la generación de cultura sobre el
            respeto del Derecho de Autor y los Derechos Conexos por medio de la
            capacitación y difusión, y promover la investigación y el desarrollo
            en materia la materia autoral.
          </p>
        </div>
      </div>
