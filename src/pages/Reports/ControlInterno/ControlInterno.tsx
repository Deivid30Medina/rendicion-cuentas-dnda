  ...
  return (
    <>
      <div className="w-full flex items-start justify-between flex-nowrap pt-12 gap-4">
        <IconControlInterno
          className="h-20 w-52 border-2 border-color-dnda rounded-lg"
          colorSVG="#004884"
        />
        <div className="flex flex-col items-start justify-center">
          ...
          <p>
            Su objetivo es orientar las acciones de Control Interno hacia el
            logro de los objetivos, racionalización del gasto público y el
            alcance de niveles de transparencia, economía y eficacia en la
            gestión, según lo establecido en la Ley 87 de 1993, ley 1474 y demás
            normas concordantes.
          </p>
        </div>
      </div>
      <div className="w-full pt-16 grid place-items-start justify-items-stretch gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
        <a className="sm:mx-0 md:mx-0 xl:mx-0" target="_blank" href="reports/reporte-control-interno.pdf">
          <div
        ...
        <a className="sm:mx-0 md:mx-0 xl:mx-0" target="_blank" href="presentation/Presentacion-control-interno.pptx">
          <div
            className={`h-auto flex items-center justify-start flex-nowrap  hover:bg-white bg-color-dnda-card border-2 hover:border-color-dnda rounded-lg duration-700 hover:scale-105`}
          >
