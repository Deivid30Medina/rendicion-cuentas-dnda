  ...
  theme: {
    extend: {
      colors: {
        ...
        "color-icon-conciliacion": "#FF0000",
        "color-icon-ucsti": "#B51CFD",
        "color-icon-controlInterno": "#AF4700",
        "color-icon-direccionG-degradado": "rgb(0 55 178 / 15%)",
        ...
        "color-icon-conciliacion-degradado": "rgb(255 0 0 / 15%)",
        "color-icon-ucsti-degradado": "rgb(181 28 253 / 15%)",
        "color-icon-controlInterno-degradado": "rgb(175 71 0 / 15%)",
      },
      borderWidth: {
